...
void vertex(in App2Vert vin, out Vert2Frag vout,
        ...
        uniform float FloatParam3_Fade,
        ...
        )
{
    ...
    float blend=0.5*(1+FloatParam2_TimeSine);
    blend=1-blend*FloatParam3_Fade;
    vout.diffuse = float4(color.xyz,blend);
            ...
            ) : COLOR
{
    ...
    src.xyz*=saturate(In.diffuse.xyz+tex2D(Texture1,In.lmUV).xyz);
    src=saturate(src+reflection)*In.diffuse.w;

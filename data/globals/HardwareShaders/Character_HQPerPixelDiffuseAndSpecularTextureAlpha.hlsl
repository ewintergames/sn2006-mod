...
struct Vert2Frag
{
    ...
    half3 light0HalfAngle : TEXCOORD5;
    half3 light1HalfAngle : TEXCOORD6;
    half3 light2HalfAngle : TEXCOORD7;
    half  fog             : FOG;
        ...
        )
{
    ...
    vout.specularAttenuation = saturate(half3(l0Att,l1Att,l2Att));
...
// #default SpecularEffectOnAlpha = 1

#define BW3 half3(0.239,0.686,0.075)
...
half4 main(in Vert2Frag In, 
            ...
            uniform half FloatParam5_SpecularAdd,
            uniform half FloatParam6_SpecularEffectOnAlpha
            ) : COLOR
{
...
//    half3 halfAngle2=normalize(In.light2HalfAngle.xyz);
    half3 specularFactor=saturate(half3(dot(normal,halfAngle0),dot(normal,halfAngle1),0/*dot(normal,halfAngle2)*/));
    ...
    half specularPower=dot(specularColor,BW3);
    half specScale=textureColor.w*FloatParam4_SpecularScale+FloatParam5_SpecularAdd;
    half4 color=half4(textureColor.xyz*light + specularColor*specScale,textureColor.w+specularPower*FloatParam6_SpecularEffectOnAlpha);

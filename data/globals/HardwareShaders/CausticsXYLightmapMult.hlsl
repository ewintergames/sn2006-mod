        ...
        )
{
    ...
    vout.caustic1UV = pos.xy*0.01*VectorParam1_Caustic1Scale.xy+frac(VectorParam2_Caustic1Drift.xy*FrameTime);
    
    float2 uv2Pos=float2(dot(pos.xy,RotationParam7_Caustic2Rotation.yz),dot(pos.xy,RotationParam7_Caustic2Rotation.xy));
            ...
            ) : COLOR
{
	...
	half4 causticMult = (caustic1+caustic2)* half4(lightmap,1);

    src=saturate(src + causticMult);
    return src;
}

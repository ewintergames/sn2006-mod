// #class Object
// #SkinningReplacement SFX_Gizmo_HWSkin
// #NoFog
        ...
        )
{
    ...
    vout.color=float4(dif.xyz,(0.85+0.25*FloatParam1_TimeSine)*Blend.x);
}
        ...
        uniform float FrameTime) : COLOR
{
    ...
    return float4(saturate(3*intensity.xxx)*float3(0,0.217,1),In.color.w);
}

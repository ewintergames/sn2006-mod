...
struct Vert2Frag
{
    ...
    float2 mask1UV  : TEXCOORD4;
    float2 mask2UV  : TEXCOORD5;
};
...
// #default Texture3_Full_screen_mask = ui\TV_Border_01.tga
...
half4 main(in Vert2Frag In, uniform sampler2D Texture0, uniform sampler2D Texture1,
            ...
            uniform sampler2D Texture3_Full_screen_mask, uniform half4 VectorParam1_FS_mask_color,
            ...
            uniform half4 VectorParam3_Lookup_intensity) : COLOR
{
    ...
    picture+=glow*ConstantColor.xyz;

    half4 fsMask=half4(tex2D(Texture3_Full_screen_mask,In.screenUV))*VectorParam1_FS_mask_color;

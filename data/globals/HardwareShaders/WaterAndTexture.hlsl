...
// #default TextureIntensity = 0.5
// #default LightMultiplicator = 1
...
void vertex(in App2Vert vin, out Vert2Frag vout,
        ...
        uniform float FloatParam7_LightMultiplicator,
        ...
        )
{
    ...
    color=Ambient+color*FloatParam7_LightMultiplicator;
        
    vout.diffuse = float4(color.xyz,dot(color,BW));
            ...
            ) : COLOR
{
    ...
    ret.w=saturate(dot(ret,BW)*FloatParam5_BlendingFactor+0.1);
    
    ret=tex*texBlend+ret*(1-texBlend);
    return ret;
}

        ...
        )
{
    ...
    vout.caustic1UV = pos.zy*0.01*VectorParam1_Caustic1Scale.xy+frac(VectorParam2_Caustic1Drift.xy*FrameTime);
    
    float2 uv2Pos=float2(dot(pos.zy,RotationParam7_Caustic2Rotation.yz),dot(pos.zy,RotationParam7_Caustic2Rotation.xy));
